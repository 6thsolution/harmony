...
class JwtAuthenticationControllerApi {
  ...
  const JwtAuthenticationControllerApi(this._dio, this._serializers);

  /// authenticateUser
  ///
  /// 
  Future<Response<JwtResponse>> authenticateUserUsingPOST({ 
    required JwtRequest loginRequest,
    ...
    try {
      const _type = FullType(JwtRequest);
    ...
    JwtResponse _responseData;

    try {
      const _responseType = FullType(JwtResponse);
  ...
  ///
  /// 
  Future<Response<SignUpResponse>> registerUsergoogleUsingPOST({ 
